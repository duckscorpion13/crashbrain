...
// v 2. optional(statusBarView.backgroundColor)
//  3. optional(JSON API URL)
// v 4. optional(Push Notifications)
// v 5. clearCache
...
// v 11. Add deviceInfo
//  12. Info.plist : Privacy - Camera Usage Description/Photo Library Usage Description
